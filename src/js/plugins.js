...
!(function (e, t) {
	...
	return (function (l) {
		...
		return (
			...
			(o.d = function (e, t, l) {
				o.o(e, t) ||
					Object.defineProperty(e, t, { enumerable: !0, get: l });
			}),
			(o.r = function (e) {
					...
					var l =
						...
						r =
							3 < arguments.length && void 0 !== arguments[3]
								? arguments[3]
								: document;
					if (l && -1 !== c(r.querySelectorAll(t)).indexOf(e))
						return e;
					for (
						;
						(e = e.parentElement) &&
						-1 === c(r.querySelectorAll(t)).indexOf(e);
			...
			var u = ["padding", "margin", "width", "max-width", "none"],
				...
				A = function (e) {
					if (a(e)) {
						...
						return (
							(e.style.borderLeftWidth = l),
							(e.style.borderRightWidth = r),
							o
						);
					}
					return 0;
				...
				F = function (e) {
					e &&
						r(e).map(function (t) {
							w.scrollableSelectors =
								w.scrollableSelectors.filter(function (e) {
									return e !== t;
								});
						});
				},
				...
				H = function (e) {
					...
					if (a(e)) {
						...
						if (
							"" ===
								e.getAttribute("data-scroll-lock-lockable") ||
							t
						)
							l = g(e, !0);
						else {
